...
import { ArrowLeft, Upload, Trash2, Image as ImageIcon, Video, Palette, Loader2, MessageSquare, Send, User as UserIcon, XCircle, Bookmark, Download as DownloadIcon, Settings, Users, Shield, Scissors, X } from 'lucide-react';
                        ...
                        <div className="flex flex-wrap gap-2">
                          {u.is_blocked ? (
                            <button 
                              ...
                              className="flex-1 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border bg-emerald-500/10 border-emerald-500 text-emerald-500 transition-all"
                            >
                              Unblock
                            </button>
                          ) : (
                            <div className="flex flex-wrap gap-1.5 w-full">
                              <button 
                                ...
                                className="px-3 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border bg-red-500/10 border-red-500/30 text-red-500 hover:bg-red-500 hover:text-white transition-all"
                                title="7 Days"
                              >
                                7d
                              </button>
                              <button 
                                onClick={() => handleBlockUser(u.id, 336)}
                                className="px-3 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border bg-red-500/10 border-red-500/30 text-red-500 hover:bg-red-500 hover:text-white transition-all"
                                title="14 Days"
                              >
                                14d
                              ...
                              <button 
                                ...
                                className="flex-1 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border bg-red-600/20 border-red-600 text-red-500 hover:bg-red-600 hover:text-white transition-all"
                      ...
                      <div key={cat.id} className="p-4 bg-white/5 border border-white/10 rounded-2xl group relative overflow-hidden">
                        <div className="absolute top-0 right-0 p-2 opacity-0 group-hover:opacity-100 transition-opacity flex gap-2">
                          <button 
                            ...
                            className="p-1.5 bg-cyan-500/10 text-cyan-400 rounded-lg hover:bg-cyan-500 hover:text-white transition-all shadow-lg shadow-cyan-500/10"
                            title="Edit Category"
                          >
                            <Settings className="w-4 h-4" />
                          </button>
                          <button 
                            ...
                            className="p-1.5 bg-red-500/10 text-red-500 rounded-lg hover:bg-red-500 hover:text-white transition-all shadow-lg shadow-red-500/10"
                  ...
                  <div className="fixed inset-0 z-[110] flex items-center justify-center p-6">
                    ...
                    >
                      <div className="flex items-center justify-between mb-8">
                        <div>
                          <h2 className="text-xl font-black text-white uppercase tracking-tight">Edit Category</h2>
                          <p className="text-white/40 text-[10px] font-bold uppercase tracking-widest">{editingCategory.type} Mode</p>
                        </div>
                        <button onClick={() => setEditingCategory(null)} className="p-2 hover:bg-white/5 rounded-full transition-colors">
                      ...
                      <form onSubmit={handleUpdateCategory} className="space-y-6">
                        <div className="space-y-2">
                          <label className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] ml-1">New Category Name</label>
                          <input 
                            autoFocus
                            type="text" 
                            ...
                            className="w-full bg-black/40 border border-white/10 rounded-2xl px-5 py-4 text-white focus:ring-2 focus:ring-cyan-500/50 outline-none transition-all placeholder:text-white/20"
                          />
                        </div>
                        ...
                        <div className="flex gap-3">
                          <button 
                            type="button"
                            onClick={() => setEditingCategory(null)}
                            className="flex-1 bg-white/5 hover:bg-white/10 py-4 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] transition-all"
                          >
                            Cancel
                          </button>
                          <button 
                            type="submit"
                            className="flex-1 bg-cyan-500 hover:bg-cyan-400 text-white py-4 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] transition-all shadow-xl shadow-cyan-500/20"
                          >
                            Save Changes
                          </button>
                        </div>
